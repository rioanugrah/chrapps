        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('mikrotik.dns') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back DNS</a>
                    ...
                    <tbody>
                        @foreach ($responses as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
