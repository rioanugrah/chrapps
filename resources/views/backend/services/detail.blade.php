...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Service - #{{ explode('|', $service->service_code)[0] }}</h4>
                    <table class="table">
                        <tr>
        ...
        @section('js')
            ...
            <script>
                ...
                $('#form-simpan-nat').submit(function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('service.serviceNatRuleSimpan', ['id' => $service->id]) }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        beforeSend: () => {
                ...
                $('#form-simpan-domain').submit(function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('service.serviceDomainSimpan', ['id' => $service->id]) }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        beforeSend: () => {
                ...
                $('#form-update-nat').submit(function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('service.serviceNatRuleUpdate', ['id' => $service->id]) }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        beforeSend: () => {
                ...
                $('#form-update-domain').submit(function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('service.serviceDomainUpdate', ['id' => $service->id]) }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        beforeSend: () => {
                ...
                $('.edit-btn').on('click', function() {
                    ...
                    $.ajax({
                        url: '{{ url('admin/services/' . $service->id . '/') }}' + "/nat/" +
                ...
                $('.edit-btn-domain').on('click', function() {
                    ...
                    $.ajax({
                        url: '{{ url("admin/services/" . $service->id . "/") }}' + "/domain/" +
                        itemId, // The server-side endpoint URL
                        type: 'GET', // Use the DELETE HTTP verb
                        data: {
                            '_token': $('meta[name="csrf-token"]').attr('content'),
                ...
                $('.delete-btn').on('click', function() {
                    ...
                    if (confirm('Are you sure you want to delete this item?')) {
                        $.ajax({
                            url: '{{ url('admin/services/' . $service->id . '/') }}' + "/nat/" + itemId +
                ...
                $('.delete-btn-domain').on('click', function() {
                    ...
                    if (confirm('Are you sure you want to delete this item?')) {
                        $.ajax({
                            url: '{{ url("admin/services/" . $service->id . "/") }}' + "/domain/" + itemId +
                            "/delete", // The server-side endpoint URL
                            type: 'DELETE', // Use the DELETE HTTP verb
                            data: {
                                '_token': $('meta[name="csrf-token"]').attr('content'),
